 ...
 * ・自力AC！
 * ・UnionFind
 * ・同じ色のスライムは同じ箱に入れないといけないけど、同じ箱に何種類が入っていても構わないので、
 * 　とりあえず同じ種類を貪欲に同じところに移すことを考える。
 * 　で、この時のその箱にいるやつは他の色含め全部同じ箱になってしまう訳で、
 * 　最終的にどの箱とどの箱が合流済かって考えると、UFでマージしていけばうまくいきそう、となる。
 * 　で、必要なマージが全て終わった時、何回箱の合流が必要だったかは、
 * 　UFの最終的なグループ数を数えると分かる。これを箱全体から引けば答え。
 */
