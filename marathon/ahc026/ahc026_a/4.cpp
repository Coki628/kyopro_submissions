        ...
        rep(_, BEAM_WIDTH) {
            ...
            if (k < curbox[m].size() - 1) {
                rep(nxt, M) {
                    ...
                    op2(m, i, ops, curbox);
                    nxt_beam.push({nxwait, cost + nxcost, ops, curbox});
                    // 状態戻し
                    curbox = tmp;
                    ops.pop_back();
                    ops.pop_back();
                ...
                op2(m, i, ops, curbox);
                nxt_beam.push({0, cost, ops, curbox});
            }
        }
