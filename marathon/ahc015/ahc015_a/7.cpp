...
・同じ要領で2番目に多い種類を、今度は上下に割り振ってみる。
　ただし1番目の条件2つを最優先として、それがなかった場合にやる。
　両方なかった時は乱択で上下どっちか。これでまた伸びて125M。
・最後を乱択上下じゃなくて、下固定で試したら伸びた。これで133M。
・上下左右はどっちに割り振ってもほぼやることは変わらないので、
　逆側に寄せてみたり色々試して、一番いいやつにした。
　手元実行と提出だとやっぱりケースが違うからか微妙に良し悪しが変わった。
　結果的には右と下に寄せるのが提出としては一番良くなって、これが134M。
・本番は、結局このルールベース貪欲でIF文こねくり回しただけのやつが、
　一番いい結果を残した。前半色々頑張って準備した関数とかは、
　ほぼ全部徒労に終わった訳だけど、かなり大当たりの貪欲で
　黄パフォまで叩きだしたので、まあこれはこれで良かったんかなって感じ。
*/
