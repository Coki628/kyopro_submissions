...
ld solve(int testcase=-1) {
    ...
    while (elapsed < TL) {
        ...
        cur_beam = nxt_beam;
        // 今一番いい状態を確認
        auto [score, curans] = cur_beam.top();
