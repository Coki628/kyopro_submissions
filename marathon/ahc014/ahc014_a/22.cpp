/*
・ビームサーチを復活させた版。
　これ自体はそんなに得点よくないけど、chokudaiサーチを整える準備。
*/
...
auto solve(int testcase=-1) {
    ...
    while (1) {
        ...
        rep(_, BEAM_WIDTH) {
            ...
            auto [__, ___, ____, id] = cur_beam.top(); cur_beam.pop();
            // 状態作成
            ...
            for (auto& [p1, p2, p3, p4] : candi) {
                ...
                nxt_beam.push({a, b, c, nxtanses.size()});
