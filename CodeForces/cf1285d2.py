...
　　　https://ngtkana.hatenablog.com/entry/2020/01/11/015010
・XOR系、再帰探索(メモしない)
・2つのグループに分けたリストを引数にして持ち回る。
・最大2通りの遷移を30ビットでやるので、計算量が最大2^30*リストの要素数くらいありそうに思えるけど、
　多分思ったより早く片方に全要素集まって1通り遷移になるんだと思う。
"""
