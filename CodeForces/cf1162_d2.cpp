/*
参考：https://codeforces.com/blog/entry/66878
　　　https://codeforces.com/contest/1162/submission/111171090
・自力ならず。。
・約数列挙
・周期Nで何個ずらすかを全探索すればいいけど、N*Mはでかすぎるので無理。
・ここで、10万のN全部ではなく、Nの約数だけ見ればいい。10万以下の約数なら
　だいぶ小さくできるので、内側で20万のM全部回しても間に合う。
　言われたら確かに約数以外やる意味ないな、絶対一致しないじゃんね。。
・vector新しく作って全部詰めてvector同士比較みたいな雑なことしたら、
　ギリギリAC2.667秒。(制約3秒)
・いくら何でも遅いので改善。普通にsetで存在チェックやる感じにしたら、
　こっちのが全然速くてAC0.22秒。
　setのlogは遅めだと思ってたけどまーvector毎回生成してソートするよりは速いのか。
*/
