/*
参考：https://twitter.com/laycrs/status/1401578526885572610
・自力ならず。。
・座圧してBIT、中央値
・考察が出ない。結局、直前2つの数の間に出現した値があるとNG、
　を数列の最後まで見ていけばいいんだけど、そうだと気付く難易度高すぎ。。
　数列めっちゃこねくり回してたけど、全然分からなかった。
・まあ分かってから考えてみると、数列に要素を2個ずつ足していく手前、
　中央値はどうせ1つしかずらせないので、直前の中央値から
　今回中央値にしたい値の間に余計なのが挟まってると無理、
　って感じにはまあ思えてくる。でもこういうの出ないよねー。。
*/
