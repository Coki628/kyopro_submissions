/*
参考：https://codeforces.com/blog/entry/95525
・自力ならず。これは解けるべきだった。。。
・数え上げ、冪乗の冪乗
・最初が6通りで遷移の度に4通りずつある。でだいたい合ってたんだけど、詰め切れず。
　選択の対象となる頂点は深くなるだけ2冪で増えていくので、4を掛ける回数も2冪回で増えていく。
　答え聞いた今考えれば分かりそうな気がするのに、なんか本番では4*4から先に進まなかったんだよね。
　4*4*pow(2, i) とかはやったんだけどね。。4を掛ける回数が増えるんだから4冪だよね。。
*/
