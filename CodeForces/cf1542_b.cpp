...
・自力ならず。。
・+bを先にやる意味がない、って言われてなかなかピンと来なかったんだけど、
　*aを後でやる意味がない(+bでも同じことができる)、って考えたら分かった。
・で、これが見えると*aを先に何回やるかで全探索できる。
　後からbをやってぴったりいくかどうかは差分のmod bで分かる。
・終了状態から整数BFS、とか考えたの全然ダメ方針だったな。。
*/
