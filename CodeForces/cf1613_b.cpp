/*
・自力AC
・小 mod 大 がダメなのは確定で、それ以外は適当にやっても
　かなり大部分がOKなんじゃないの？というお気持ちで、
　とりあえずソートして 大 mod 小 となるペアを全探索、
　必要数が揃ったら打ち切り、ってやったら通った。。
・x mod y のyを最小値にすると、答えが必ずy未満となるのでほぼ全部に使える、
　というのが正答だったみたい。まあ今回はガチャが1発で当たっただけみたいなもん。
　こどふぉ前半こういうの多いから安定しないんだよね。。
　実際、これでWAかTLEが出たら乱択試そうと思ってたけど、乱択した人はTLEしたって言ってた。。
*/
