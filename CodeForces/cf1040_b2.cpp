/**
 * 参考：https://twitter.com/ItoHdak_kyopro/status/1367274532348645377
 * ・こうすれば頭壊れなくてよかった。。そのための制約1000だよなぁやっぱり。
 * ・最初に置く位置を全探索。結局mod個おきに置くのが最善なので、これで全部分かる。
 */
