...
void solve() {
    ...
    while (M >= 3) {
        ...
        ll num = toint(T[i])*100+toint(T[j])*10+toint(T[k]);
        if (not is_prime(num)) {
            print(3);
            print(num);
            return;
