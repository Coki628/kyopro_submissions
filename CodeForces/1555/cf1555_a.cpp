/*
・なんとか自力AC！
・色々割り算して場合分けしてみたいなでWAを生やした。。
・よくよく考察すると、6+0,6+2,6+4が使えて、以降も枚数増やせばできるので、
　ほぼ任意の偶数はぴったりのピースを用意できることになる。
　ほぼというのは6ピース未満は6を買うしかないので、ここは場合分け。
・考えがまとまれば自明っぽいのに、気付かないとほんとに分からないから不思議。
*/
