 ...
 * ・なんとかここまで自力AC！頑張った。
 * ・インタラクティブ、二分探索
 * ・制約条件が明らかににぶたんを誘ってる。実際、それでいい。
 * 　基本的には直線上でよくて、最初に打ったところと同じか違うかで位置を動かしていく。
 * ・でもこれだけだとWAになって、手元で最大を試すと、ギリギリ足りない場合があるっぽい。
 * 　そこで、平面なのを利用して、最後の1回だけ縦にちょっとずらしてやる。
 * 　これで最後に斜めの線を引けばOK。
 * ・TL見たけど、最初に0と10^9でやって、同じだったらそっちと逆の座標軸で続きやる、
 * 　ってやれば、最後の調整はいらなくなるっぽいね。(詳細はゆうさんの提出参照)
 */
