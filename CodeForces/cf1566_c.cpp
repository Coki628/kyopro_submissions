/*
・きっちり自力AC！
・直前までに残してある0,1の状態と今回来た2つによって丁寧に場合分け。
・DPした人も多かったぽい。多分、直前までに残してある0,1の状態を持って、
　そこで区切る/区切らないの遷移をする、だと思う。確かにこれでいけそう。
・貪欲場合分けは1個考慮漏れるともうダメなので、DPできるならした方がいいよね。
　現に今回のこれも1WAしてるし。。DP方針思いつけばよかったなー。
*/
