/*
・終了後自力AC！ちょっと考察時間かかった。。
・偶奇、場合分け
・色々悩んだけど、最終的に、確実に言えることを切り口にして考えるのがやっぱり良くて、
　今回だとどちらかの全勝はどうやっても題意の示すブレイクの回数がN/2になる。
　ここから相手方に1勝ずつ動かしていくと、必ずブレイクの回数は増えるor減る。
　これで2乗DPっぽい形でならその回数への到達可否の状態遷移が可能になる。
　さらに考察を進めると、左右端だけ分かっていれば、Nが奇数なら区間全部、
　奇数なら偶奇どちらかのみで、区間内のどこが使えるかはその場ですぐに判断できるので、
　これでO(N)で答えを出すことができるようになった。
・ちょっと時間はかかったけど、D1に割いた時間をある程度分ければ解けたっぽいし、
　後から気付いたけどD1の配点1500でこのBが1250だから、
　D1を前倒して解くメリットはかなり薄かったんだよね。。
　その辺もよく見てから立ち回るんだったかなぁ。。
*/
