...
void solve() {
    ...
    rep(i, M) {
        ...
        if (c == '1') {
            ...
            if (i == 0) {
                ans += string(max(cnt-K, 0LL), '0');
                ans += string(min(K, cnt), '1');
            } elif (i == M-1) {
                ans += string(min(K, cnt), '1');
                ans += string(max(cnt-K, 0LL), '0');
            } else {
                ans += string(min(K, cnt/2), '1');
                ans += string(max(cnt/2-K, 0LL), '0');
                if (cnt%2 == 1) ans += '0';
                ans += string(max(cnt/2-K, 0LL), '0');
                ans += string(min(K, cnt/2), '1');
            }
