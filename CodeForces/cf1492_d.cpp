/**
 * 参考：https://twitter.com/laycrs/status/1364169590205374475
 * ・自力ならず。。
 * ・場合分け、二進数の繰り上がり
 * ・まず、S-Tで最終的に1が残る条件として、
 * 　100000
 * 　000001
 * 　みたいなやつを考えてたんだけど、これの間の部分は縦が合ってれば0じゃなくても1でもいいんだよね。
 * 　両方1でもそこは相殺されるんだからそれはそう。。
 * ・でもこれが分かっても簡単には終われない。罠が多い。
 * ・リーディングゼロがダメとあるので、最初の桁は両方1にしないといけない。
 * 　で、この時さらに使える0と1が1組ずつはないと、上記の方法で1を作れない。
 * 　なんだけど、K=0の時は別に1を作らなくていいのでそれでもできる。
 */
