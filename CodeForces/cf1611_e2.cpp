/*
参考：https://twitter.com/nok0_kyopro/status/1464045874896830465
・自力ならず。思いつかなかったけど、やっぱこういうグラフ問は好き。
・HLD、LCA、DFS
・nok0さんのツイートから全てを理解した。頭いいー。
・まず、ぶつかる時がどういう状況、というか位置なのかを考えると、
　これは常に自身のいる頂点(根)と友人のいる頂点の中間地点になる。
　なので予め全ての友人を中間地点まで近づけておく。
　これはダブリングでもHLDでも、LCA遡る仕込みをやっておけばできる。
　その状態でDFSで木全体を根から走査すれば、自身がどこでブロックされるか分かるし、
　その止められた回数分は友人が必要で、重複とかもっと下の方にいる者は必要ない。
　一度でも自身が葉まで到達できればNG判定。
*/
