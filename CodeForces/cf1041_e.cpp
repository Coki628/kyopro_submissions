/**
 * 参考：https://codeforces.com/contest/1041/submission/109185721
 * ・自力ならず。
 * ・木、グラフ、構築
 * ・基本的には近い方針を進めてたんだけど、実装詰めきれなかった。
 * ・まず、どの値ペアも片方は頂点NじゃないとNG。2つに分けた時、
 * 　どっちかは必ず最大の頂点Nを含むから。
 * ・で、繋ぎ方は、自分より小さい方に向かって、例えばi=4で3つ作りたいなら、
 * 　N - 1 - 2 - 4 みたいに繋げば、(N, 4)を3つにできる。
 * 　同じ要領で全部やってくんだけど、同じ頂点を2回使おうとしたりすると
 * 　木じゃなくなったりでバグるから、使用済管理をちゃんとやる。
 * 　自分はused配列作って何とかしようとしたんだけど、次にどこから使うとかで色々困った。
 * 　結局hironekoさんの実装を参考にして、使用済管理はsetで、
 * 　それとprev変数を持って、途中繋いでいくところをうまくやることができた。
 */
