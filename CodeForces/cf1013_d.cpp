/**
 * 参考：https://twitter.com/ItoHdak_kyopro/status/1366916482987393025
 * ・自力ならず。。これは通せるべきだったな。
 * ・かなり設定の似てる類題がある。(ABC131f)
 * 　昔解説ACしてたけど、全然忘れてた…。
 * ・グリッド、グラフ、UnionFind
 * ・グリッドの行と列を頂点として、マスを辺とするあれ。
 * ・そうじゃないかと疑いもしたのに、適切な集合のまとめ方を詰めきれなかった。
 * 　やるべきことは、同じ行にある列同士、同じ列にある行同士をマージする、だった。
 */
