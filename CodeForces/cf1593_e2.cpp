/*
・システス落ち。。
・setで管理した辺を愚直っぽいシミュを引っこ抜いてくと通る。
　まあ確かに辺を外す回数は辺の数以上にはないので、確かにそう。。
・上記やってプレテス通したんだけど、テストケース数が多くてKも大きいみたいなやつで落ちた。
　確かにNは全体の上限あったけどKにはなかったね。。全部の頂点がなくなった時点でbreakしたら通った。。
*/
