/*
・きっちり自力AC！
・グラフに帰着、有向グラフの閉路チェック、メモ化再帰でDAGのDP
・依存性の関係は有向グラフを作ると良かったりする。
　この前ちょうどトポソ作ったしそれ使ってもよかったけど、
　逆辺にしてメモ化再帰のが慣れてるからそっちでやった。
・閉路検出で再帰DFS即終了にするやつ、マルチテストケースだとexit(0)できないから、
　(確かえびちゃんさんが紹介してた)例外飛ばしてtry/catchで終わらせるやつ初めて実戦で使った。
　話聞いた後メモっといて良かった。
*/
