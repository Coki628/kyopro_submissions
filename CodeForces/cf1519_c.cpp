...
・きっちり自力AC
・ソートして累積和
・各U毎にSを分けておいて、降順ソートして累積和を取る。
　これで各大学から何人取れるのか分かればすぐ和が取れる。
・取れる人数は、各グループの人数をiとすると、iで割り切れない端数を除いた数。
　各大学についてこれを全部見るが、そのままやると2乗になるのでダメ。
　iが大きくなって人数が0になると、その先は全部0なのでbreakする。
　これで元々人数が少ない大学は早めに内ループが終了するので、
　全体で均すとO(N)になるはず。実際ちゃんと通った。
*/
