/*
・自力AC！頑張ってDP復元したけど、うまい貪欲とかあるのかな。
・DP、復元
・最後に使った指を状態に持てば、達成可能か判定するDPはできる。
　今回は行った操作の復元もしたいので、さらに1つ前の状態も持って3次元にする。
・この前やったDP復元(ABC200_d)は1つ前の状態要らなかったけど、
　あれば遷移に場合分けがなかったからうまくいったんだね。
　今回みたいに普通にif文が絡むような遷移だったら、
　最短経路の復元みたいに1つ前の状態が必要だ。
*/
