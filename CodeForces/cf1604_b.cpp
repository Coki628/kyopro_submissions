/*
・きっちり自力AC！
・XORやLISで話を難しく見せているが、実際は難しくする必要がない。
　Nが偶数の時は、全部1つずつに分割すれば全部LISが1で全体を0にできるので常にOK。
　そうでない時、LISが1のまま列の長さを2にできる場所が1つでもあれば上記同様に帰着できる。
　これは隣接する要素が広義単調減少な場所が1つでもあればOKと言える。
　それ以外を考えると、残るは全体が狭義単調増加な列の場合のみだが、
　これはなんか手元で試すと常にダメそうな雰囲気がしたので、後はお気持ちぶん投げAC。
*/
