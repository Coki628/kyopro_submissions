/**
 * 参考：https://twitter.com/_yamate11/status/1367273765231419394
 * ・自力ならず。時間もなかったけど、あっても多分通せてない。
 * ・インタラクティブ、二分探索、乱択
 * ・対象が一度に移動する距離Kは10以内と小さい。適当ににぶたんで範囲を狭めたあと、その範囲内で乱択をやると当たる。
 * 　どこから乱択するかで、Kが10なので最初倍の20でやってTLEで、40でもダメで、100にしたら通った。多分これが狭すぎると、
 * 　乱択からにぶたんに戻る時に広げる範囲が狭すぎて逃げられてしまうんだと思う。
 * 　100だと乱択が広すぎて当たらなそうに思えたけど、意外とそれは当たるみたい。
 */
