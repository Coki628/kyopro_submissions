/*
・自力WA。システス落ち。。
・1～Nまで順方向には確実に進めるので、1つでもN+1に向かう方があれば、
　そこでN+1に行って、すぐ戻ってくるようにする。
　よって後ろから見て、最初に0が来た所でN+1に行って、その直後は1のはずなのでそこで戻る。
・これ自体はまあ良かったんだけど、N+1に向かう場所が1つもなかった時、
　行きようがないと思ってNGにしてしまったんだけど、
　これは最初にN+1からスタートすればいいだけの話だったんだよねー。頭ついてなかった。。
・でも全部1のケースがプレテストに1が1つだけのやつしか含まれてないのは弱くないかと。。
　その場合分けだけですっかりコーナーケースを回避した気になってしまったよ。
　まあアホみたいな見落としをやらかした自分がいけないんだけどね。。
*/
