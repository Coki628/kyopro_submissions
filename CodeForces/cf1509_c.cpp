/*
・きっちり自力AC！これはまあまあ早かった。
・ソートして2乗の区間DP
・ソートして、隣接する要素から使っていくことを考える。
　考えがまとまると、すごく教科書通りな区間DPに仕上がる。
*/
...
void solve() {
    ...
    auto rec = [&](auto&& f, ll l, ll r) -> ll {
        ...
        ll res = min(f(f, l+1, r), f(f, l, r-1))+(A[r]-A[l]);
        memo[l][r] = res;
        return res;
    };
    ll ans = rec(rec, 0, N-1);
    print(ans);
}
