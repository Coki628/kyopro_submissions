 ...
 * ・ギリギリ自力AC！時間かかったー…。
 * ・GCD系、構築、辞書順最大
 * ・題意を満たすには、とにかく先に大きい値が来た方がいい、つまり全体GCDを
 * 　できるだけ早く1じゃなくした方がいいので、基本的にはまずは偶数だけにする。
 * 　その先は、2冪部分が大きいものを優先して残す。
 * ・基本的にはこの方針で良かったんだけど、例外があって、最後は何が残ってもいいので、
 * 　ここで2より3を残した方がよくなる場合がある。
 * 　最初N=3だけ、とか6,7も、とかで例外処理を場合分けしたんだけど通らなくて、
 * 　結局全部構築した後に、最後の要素だけ2と3入れ替えてみてN以内ならそっち使う、ってやってAC。
 * 　場合分けは要らなかった。
 */
