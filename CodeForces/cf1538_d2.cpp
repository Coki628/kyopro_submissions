/*
参考：https://twitter.com/laycrs/status/1403031871454285825
・laycrsさんがintにしたら通ったって言ってたので、そうしたら通った。
　まあでも確かに√10^9の素因数分解1万ケースは結構厳しいか。
*/
...
void solve() {
    ...
    auto fact1 = factorize(a);
    auto fact2 = factorize(b);
    ll cnt1 = 0;
    for (auto [k, v] : fact1) {
        cnt1 += v;
    }
