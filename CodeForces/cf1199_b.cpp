/*
参考：https://codeforces.com/blog/entry/68812
・自力ならず。これ気付けなかったのはつらい。。
・三平方の定理、式変形
・三角関数で角度求めたり、補助線引いて何か見えないか考えたり、
　どっか1つ決めればにぶたんできないか考えたり、
　1時間くらい色々試行錯誤したけど結局解けなかった。。
・蓋を開ければ、三平方の定理。a^2+b^2=c^2 に当てはめて式変形すれば、
　ほんとに簡単な式になる。
*/
