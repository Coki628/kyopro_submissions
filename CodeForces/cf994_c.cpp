/**
 * ・自力AC！
 * ・つまるところ整数座標だけ全チェックすればOK。斜めがめんどい。頑張る。
 * 　縦の進行に合わせて、横幅を半分までは増やして半分以降は減らす、みたいにした。
 */
...
void solve() {
    ll N = 4;
    vector<pll> XY1, XY2;
    ll mnx1 = INF, mny1 = INF, mxx1 = -INF, mxy1 = -INF;
    ll mnx2 = INF, mny2 = INF, mxx2 = -INF, mxy2 = -INF;
    rep(i, N) {
        ll x, y;
        cin >> x >> y;
        XY1.pb({x, y});
