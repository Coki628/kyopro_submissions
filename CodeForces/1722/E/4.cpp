...
・後日、ほぼ同じくらいのサイズの問題(abc339_g)をこれ使って解いたら
　メモリ100MBくらいしか使わなかったので、こちらも色々試してみた。
　どうやらマルチテストケースだとメモリ解放しないとマズいみたいだ。
　デストラクタにそういう処理を足すと、400MB台になった。
　まだ多いので、NODESを2000万から1000万に減らしたら、200MB台になって無事AC。
　にしてもAtCよりメモリ消費が4倍以上多いのは謎だけど分からん。
*/
...
template<typename T, typename F, int NODES = 10000000>
