/*
参考：https://twitter.com/laycrs/status/1418611248925536258
・自力ならず。。
・条件を工夫してソートして貪欲
・それかそれ以外に分けてソートするのは考えたんだけど、
　「それ/それ以外」みたいなのしか頭になくて、これじゃ最適にならなそう、、
　ってなってたんだけど、「それ-それ以外」でよかった。
　たまにこういう典型考察っぽいの落とすのほんとやめたい。。
*/
