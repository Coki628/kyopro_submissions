/*
・遅延セグ木、区間or
・先に書いて、うまく動かなくて捨てた方。l,rが逆になったままという凡ミスが原因だった。
　作用素でor演算使うのは多分初めてだったけど、ちゃんと動いた。
　しかも今回はDPパートのがビット毎に見るlogが乗ってボトルネックみたいで、
　個数管理する方とこの遅延セグ木でほとんど速度変わらなかった。
*/
