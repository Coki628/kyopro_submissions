/**
 * 参考：https://codeforces.com/contest/975/submission/107891392
 * ・累積和にぶたん
 * ・そうだよね、こうすればよかった。動いたindexからの区間和、みたいなことをゴチャゴチャやったのが敗因。
 * 　オーバーしてリセットされるまで、クエリの値は積み増していけばよかったんだよね。
 * 　これなら毎回素直に先頭からの値でにぶたんするだけ。バグらない。
 */
