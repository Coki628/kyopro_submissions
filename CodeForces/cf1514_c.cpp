/*
・自力ならず。
・実験エスパー、互いに素、ウィルソンの定理
・実験したけどエスパーできず。。Nと互いに素なものが多いほどたくさん使われるなー、
　は思ったけど、全部使われるかと言うと、
　直前のやつとか使われたりそうじゃなかったりだしなー。。で終わった。
・結局これは近くて、直前のやつが使われるかそうじゃないかのどちらかが正解だそう。
　この辺の話はウィルソンの定理って考え方を使うと見えるらしいけど、
　調べたら素数だと全部掛けした時mod Nで-1になるよ、みたいな話っぽいんだけど、
　それだけじゃ、1つ減らした時1になる理由にならなくない？となった。
*/
