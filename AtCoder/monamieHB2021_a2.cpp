/*
参考：https://atcoder.jp/contests/monamieHB2021/editorial
・その他埋めAC数上げ
・式変形、全探索
・公式解。こういうアプローチができないと、この手の問題いつまで経っても速解きできないね。。
・足8本のカニは13匹でエビ4匹にできるし、10本のは13匹でエビ5匹になる。
　よってそれぞれ13匹以上いる場合は考えなくていい。
　これなら両方のカニを全探索できる。そこを固定すれば式変形でエビが一意に定まるから、
　これがあり得る値ならそこでのカニの匹数を答えの候補として採用すればいい。
・カニをできるだけエビに置換して考える方針は取ったのに、
　両方のカニまとめちゃったから沼ったんだよな。
　O(1)にならなくても、適当に分かりやすい分だけ状態減らせば十分全探索できたのに。
*/
