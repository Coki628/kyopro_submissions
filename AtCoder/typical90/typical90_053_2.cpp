/*
参考：https://twitter.com/e869120/status/1398827248698810369/photo/3
・E8さん典型90問、残りの高難度埋め
・これは部分3
・インタラクティブ、差分で二分探索
・公式では微分って言ってたけど、ようは差分で二分探索して、0以下になる最小位置を見つければいい。
・なんとなくさぶたんのが回数多いのは分かってたけど、
　こうやって2回ずつ取ってもまだにぶたんのが少ないんだな。
　まあさぶたんって内部的に1回で2回ずつクエリ投げてるし、それはそうか。。
*/
