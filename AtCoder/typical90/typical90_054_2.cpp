/*
参考：https://twitter.com/e869120/status/1399496993014116352/photo/1
・E8さん典型90問埋め
・BFS、超頂点
・公式解の方針。知見なのでやっておく。
・今回困ったのは、論文による関係を素直に全部辺で張ろうとすると、
　各論文についてその部分に完全グラフみたいな辺を張らないといけなくなり、
　これをやるとM^2になるからダメだなぁ、って話。
　で、これは実は人の頂点N個に加えて論文の頂点M個を超頂点で作れば、
　そこを経由してどこでも行けるような辺を張ることで同じようにできる。
　これだと辺の数は2乗にならず、問題なくACできる。
*/
