/*
・E8さん典型90問埋め
・自力ならず。これは一生思いつかなそうなので早めに答え見てよかった。
・言い換え、グラフに帰着、最小全域木
・考察むずすぎ。最小全域木どころか1ミリもグラフに帰着させる発想はなかった。。
・しょうもないお気持ち解釈しかできてないけど、一応書いておく。
　まず、区間反転操作を差分の列で考えると、状態が変わるのはl-1とrの2箇所だけになる。
　で、任意の状態を作るためには、この変化点みたいのが全部の場所を網羅しなきゃダメそうだな、
　って気持ちになる。あとはいかに低コストで全部の点を繋ぐかなので、これは最小全域木の構築になる。
*/
