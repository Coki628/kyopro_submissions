/*
参考：https://twitter.com/e869120/status/1382827276673306624/photo/1
・E8さん典型90問埋め
・自力ならず。やっぱ数え上げはつらめ。。
・調和級数、nCr数え上げ
・実は何個選ぶかのaを1つずつ見て行ってもこれは調和級数で少ないので大丈夫、
　は言われたらああ確かに、ってなる。自分としてはnCrを考えるパートのがつらい。
・結果的に各aについて nCr(N-(k-1)*(a-1), a) になるんだけど、
　これは最後以外のa-1箇所には、直後に置けない場所がk-1箇所発生するので、
　その分を除いたN-(k-1)*(a-1)箇所からa個を選ぶ、って話みたいだ。
　なんか色々位置が定まってなくて、めちゃくちゃダブルカウントしてそうな
　感じのする方針だと思うんだけどこれで大丈夫みたい。数え上げ分からん…。
*/
