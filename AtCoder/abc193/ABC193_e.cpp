 ...
 * ・きっちり自力AC！いい感じ！
 * ・周期、中国剰余定理
 * ・2つの異なる周期から、ちょうどよくなる場所を見つける。
 * 　探したい範囲は制約をよく見ると小さいので、2重ループで全探索できる。
 * ・ついこの前E8さん埋めでABC150dを解いて、別解だけどCRTを使ってたので、
 * 　かなり素早くACLから取り出して対応することができた。
 * ・あとサンプルに10^18超えるケース置いてくれてるの優しい。
 */
