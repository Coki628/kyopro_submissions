/*
・きっちり自力AC！
・さんざんDで悩んでからこっち通した。もっと早くこっち通せばよかったかね。
・ビット演算の性質、上位ビットから貪欲
・(a & b) ^ (a | b) というのが出てくるが、つい最近 (a & b) + (a | b) = a + b
　というのをやったので、これは a ^ b になりそうだなぁとなる。
　実際ちょっと試すと成り立ちそうだったのでこの方針で考える。
・a + b - (a ^ b) だとようはどちらかどちらか片方だけそのビットが立っていると、
　xorでも立ってしまうので引かれていまう。逆に両方立ってると引かれずに済む。
　また、ビット演算のみの場合は上位ビットで有利になったものが下位ビットで何やっても
　覆らないというのがあるので、上位ビットから貪欲にビットが立ってる2つを選んでいく方針でいける。
*/
