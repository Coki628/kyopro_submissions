/*
参考：https://docs.google.com/presentation/d/1GTepVnEWlbxrQjr_tHM-rB3C0Ypd_zIwarH7PfclZi8/edit#slide=id.g3c58d77d55_0_10
　　　https://logfiles.hatenablog.com/entry/2018/07/16/173922
・その他埋めAC数上げ
・概ねアプローチは良かったんだけど、詰めで時間かかったので公式解の方針を。
・式変形
・2つ前,1つ前の値をa,b、最初の項の後ろをxとして、 res = a+b*x みたいに表せて、
　このresをNとして式変形すれば、 x = (N-a)/b で欲しいxが一意になる。
　これが整数なら答えの候補として使える。また、この方針でも
　自分がやったのと同じようにフィボナッチ進めてく感じなので、
　a,bがNより大きくなる辺りまで見て終わりにすればOK。
・こういう式変形が自力でちゃんとまとめられれば、
　実験エスパーみたいな力技しないで素早くこういうのを倒せるんだけどなぁ。
*/
