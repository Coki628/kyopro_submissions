...
・試験管青diff残埋め
・結構すんなり自力AC！やったね。
・貪欲、区間スケジューリング、優先度付きキュー
・右端が短いものから貪欲に処理するやつ。
　隣接リストで区間を持っておいて、左端が来たらそこから出してプリキューに詰める、
　枕に合う人を決める時はその時点で左端を過ぎてキューに入ってる人の中から、一番右端が早い人を使う。
・これは考察→実装と全てすんなり進めて一発AC。全ての青diffこうだったらいいんだけどね。。
*/
