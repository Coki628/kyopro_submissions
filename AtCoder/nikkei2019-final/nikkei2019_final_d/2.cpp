/**
 * ・E8さん精選100+50問埋め：平方分割
 * ・なんとか通せた！長かったー。色々バグらせた…。
 * ・クエリ平方分割
 * ・基本的にはyukico877でやったのと同じ感じで、√Nのバケットに分けて、
 * 　バケット全体を含む所はまとめて処理、端は各要素を見る、とやる。
 * ・全然WAが取れなくてつらかったけど、まず右端のバケットが、
 * 　半開区間じゃなくて閉区間のrで見ないと範囲外指してバグることあるね…。
 * ・で、根本的にダメだったのは、端の処理で均一でなくなった区間の
 * 　余ってるやつにその後の処理してなかった。
 * 　区間が均一じゃなくなっていたら、一括処理の時に余ってた分も消化して均一に戻す、
 * 　みたいなことをしないといけなかった。
 * ・なんとかAC1.898秒。20万に√付くにしろ遅すぎだろー。
 * 　他にC++でこんな遅い人いないので、絶対何かがダメなんだよな。
 * ・ちょっとループまとめて定数倍削減したけどあまり変わらず1.810秒。
 */
