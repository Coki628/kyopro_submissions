...
・やっとAC。XorBasisクラスが持ってたvectorを固定長のarrayにしたらめちゃ速くなった。
　前にセグ木に行列乗せるやつでarrayに変えて速くなったのを思い出してやったんだけど、試してみて良かった。
・これだと余裕になって、AC1.26秒くらい。(制約3秒)
・あとバケットサイズをkobaeさんのと合わせて50くらいにしてたんだけど、
　これもいつも通りの√Nくらいに戻しても変わらなくなったので戻した。平方分割なんも分からん…。
*/
...
const int MXLOG = 60;
using xorbasis = XorBasis<ll, MXLOG>;
...
const int L = 632;
vector<pll> bucket[L];
xorbasis accl[L][D+1], accr[L][D+1];
