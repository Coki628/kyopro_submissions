/*
参考：https://atcoder.jp/contests/agc050/editorial
・AGC青diff以下残埋め
・自力ならず。これはまあ答え聞いちゃってたし。。でも絶対自分では出ない。
・2冪
・2冪で2分木っぽくしていくことを考えると、確かに効率よく到達できそう。
　さらに、mod Nで戻ってくる感じにすれば、大きい所から小さい所も同じ感じでいけそう。
　全部お気持ちのみ。そして自分でこの考えに至るのは何回転生しても無理じゃないかと思ってる。
*/
