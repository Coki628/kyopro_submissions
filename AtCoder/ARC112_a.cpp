/**
 * ・自力AC！
 * ・サンプルエスパーで、これは等差数列の和になりそう、とやると、ちょっと合わない。
 * 　合わないやつを良く見ると、Lが大きい。手元で試すと、LがRの半分以下じゃないと
 * 　そもそも1つもできなそう。じゃあ L*2 > R は0で場合分け。これで通った。
 * ・でも今よく見たらこれ場合分けっていうか、その[L*2,R]の区間長が負になったら0だねって感じか。
 */
