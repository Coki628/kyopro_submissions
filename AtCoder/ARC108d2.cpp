/*
参考：https://atcoder.jp/contests/arc108/editorial
　　　https://www.youtube.com/watch?v=s4r2AJRagjs
・ARC青diff残埋め
・自力ならず。これは一生分からない系。。
・場合分けゲー
・これは分からん。さっさと解答見てよかったな。制約N<=1000もあって、一生2乗のDP方針考えてたと思う。
・適切に場合分けを考えると、3通りくらいになる。詳細はソース内コメント。
・最後の線形DPパートはフィボナッチでいいらしいけど、普通にDPしてもOKだって。
・対称の反対側が微妙に違ってて、答え聞いてからも一生バグらせてた。。
*/
