...
・なんとか自力AC！
・実験、OEIS、フィボナッチ
・各iの時の寄与みたいのが分かれば良いんだけど、
　DPして通り数求めるだけだと最後のしか分からない。。
・N=8くらいで実験してOEISにかけたら、フィボナッチっぽい話が出てきて、
　実際それと似たような感じでフィボナッチの前の方と後ろの方を掛けると、
　それっぽい数が出てくるのでそれを使う。
*/
...
void solve() {
    ...
    //     rep(i, N-1) {
    //         ll j = i+1;
    //         if (bit>>0 & 1 or bit>>i & 1 and bit>>j & 1) {
    //             ok = 0;
    //             break;
    //         }
    //     }
