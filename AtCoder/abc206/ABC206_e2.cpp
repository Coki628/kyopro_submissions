/*
参考：https://kanpurin.hatenablog.com/entry/2021/06/19/224001
　　　https://qiita.com/drken/items/3beb679e54266f20ab63#8-%E6%B4%BB%E7%94%A8%E4%BE%8B-5%E6%B7%BB%E5%AD%97-gcd-%E7%95%B3%E3%81%BF%E8%BE%BC%E3%81%BF
・別解。かんプリンさんとけんちょんさんの記事を参考に。
・添字GCD畳み込み
・実はGCDのペアについては、a+bの全ペアを列挙する普通のFFTみたいなことができる。
　けんちょんさんの記事に分かりやすく書いてある。
　これを知っていたら、約数系包除の考察が出なくてもこの問題に対応できる。
　しかも計算量もloglogNだから同じくらい速い。
*/
...
void solve() {
    ...
    rep(i, L, R+1) C[i] = 1;
    // GCD畳み込み
    auto res = gcd_convolution(C, C);

    // GCDが2以上のもの
    ll ans = 0;
    rep(i, 2, R+1) ans += res[i];
