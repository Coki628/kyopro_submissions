/*
参考：https://atcoder.jp/contests/abc206/editorial
・自力ならず。。Grundy数みを激しく感じつつも、区間の扱いをどうそこに適用させていくかが分からなった。
・Grundy数、複数山Nim、区間DP、メモ化再帰
・だいぶ前に蟻本演習で多分やった。Grundy数で状態を分裂させて、複数山Nimみたいにマージするやつ。
　状態をどう持っていけばいいか分からなかった訳だけど、
　使った部分はないものとして、狭めればいいね。。
　で2つの小さい状態で再帰的に試していく訳で、戻り時にxorで複数山Nimみたいにマージする、と。
*/
