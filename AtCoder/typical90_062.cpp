...
・なんとか自力AC！
・後ろから見る、逆操作
・終了状態から遡ることを考えると、だんだん使えるものが増えていく感じになる。
　どれを使うと、どれが使えるようになるかを隣接リストに持たせておく。
　で、使用済管理しながら、適当にキューかなんかに詰めてやってく。
　データの持ち替え方がやや直感に反してて思いつきにくいと思った。
*/
