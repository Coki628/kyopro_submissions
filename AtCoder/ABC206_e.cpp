/*
参考：https://blog.hamayanhamayan.com/entry/2021/06/19/233919
・自力ならず。
・約数系包除
・はまやんさんの記事が一番しっくり来た。
・まず互いに素でないペア、つまりg!=1となるものを全部数える。
　これにはgを固定して、右端から2まで後ろから見ていくと良くて、
　後ろが決まっていれば、自分の倍数の分を引きに行ける。
・後はここから一方が他方の倍数であるものを引けばOK。
*/
