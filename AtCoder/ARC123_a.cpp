/*
・自力AC！1ペナが痛かったな。。
・公式解は変数を1つにまで減らして簡潔にしてたけど、それは発想がむずそう。
　自分はb-aとc-bの2つの差分の数列にして処理した。
・差分で見ると、題意の操作はそれぞれ、
　・abを-1
　・abを+1,bcを-1
　・bcを+1
　の3つになって、操作回数を減らしたいので、
　なるべく2番目の操作をしてから最後に1か3をやるのがいいとなる。
　後はabとbcの大小によってどの操作をするか場合分け。
*/
