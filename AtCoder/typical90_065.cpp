/*
参考：https://github.com/E869120/kyopro_educational_90/blob/main/editorial/065-01.jpg
・E8さん典型90問埋め
・部分点2まで。まあこれも自力じゃなくて解説見たんだけど。。
・nCr数え上げ、工夫して全探索
・玉の総数Kは決まっているので、r,gを決めればbは一意になる。
　条件を満たすような状態だったらnCrで各色のボールを数えた後で掛け合わせる。
　これで2重ループまでは計算量を減らせる。
*/
