...
"""
参考：https://www.youtube.com/watch?v=xRYReB8pc2E&t=1681s
　　　http://tutuz.hateblo.jp/entry/2019/02/09/173018
　　　https://qiita.com/drken/items/a207e5ae3ea2cf17f4bd
・蟻本演習2-3-15
・部分文字列DP、復元、辞書順最小
・dp[nxt[i][c]+1] + 1 が+1+1みたいで最初謎だったけど、りんごさん公式解説動画が考え方の理解に一番良かった。
・計算量20万のN*アルファベット26文字で20万*26=520万、pythonTLEでpypyAC0.4秒。
"""
