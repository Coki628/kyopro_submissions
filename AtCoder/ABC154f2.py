...
"""
参考：https://twitter.com/mugen_1337/status/1226502599882375169
・すげーな、これ調べて出せるのか。
・wolframalphaにて、sum[sum[combination(i+j, i), j=0 to C], i=0 to R]と打ち込む。
・式が出るので、それを元に2次元で区間和取る時の要領で4点足し引きする。
・追記。Sum[Combination[x+y,x],{x,a,b},{y,c,d}]ってやると4点足し引きも済んだ形が出る。。
"""
