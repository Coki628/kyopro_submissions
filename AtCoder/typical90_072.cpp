...
・自力ならず。。ひどいわこれは。
・(メモしない)再帰全探索、バックトラック
・さんざん迷走して、結局愚直に再帰全探索で間に合うんかいー、ってやつ。。
・がんぽんさんが言及してたけど、終わってみれば、past202012_gとほぼ同じじゃんね。
　その時はすぐ再帰全探索って思ったのにな。。
*/
...
void solve() {
    ...
    auto rec = [&](auto&& f, ll s, ll prv, ll h, ll w) -> ll {
        ll i = gridtoid(h, w, W);
        if (prv != -1 and i == s) {
            return 0;
        }
