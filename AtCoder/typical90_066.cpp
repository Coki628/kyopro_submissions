...
・ちょっと悩んだけど自力AC！
・期待値の線形性
・制約とか見た感じから期待値DPを疑って詰まってたけど、DP要らなかった。
　そこまでの数字の出方を全部持たないと転倒数数えられないじゃんって思ったんだけど、
　全部の手が均等に起こりうるので状態は1つで良くて、
　その場その場で必要な期待値を出して状態に追加していけばOK。
*/
