/*
・自力AC！
・オンライン、Rectagle Sum、重み付きWM
・クエリ内容がものすごくストレートで、何か罠があるのか警戒してしまったが、
　Rectagle Sumがあれば通る。
　オンラインクエリに関する暗号化/復号処理は初めてやったけど、
　こういう感じで1つ前の答えを次の復号に使うんだね。
*/
...
void solve() {
    ...
    WaveletMatrixRectangleSum<ll, 32, ll> rectsm(vec1, vec2);
    ll Q;
    cin >> Q;
    ll b = 0;
    rep(i, Q) {
        ...
        l ^= b, r ^= b, x ^= b;
        l--;
        ll res = rectsm.rect_sum(l, r, 0, x + 1);
        print(res);
        b = res;
    }
}
