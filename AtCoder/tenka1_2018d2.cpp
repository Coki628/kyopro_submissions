 ...
 * ・自力AC！やったね。
 * ・構築、三角数
 * ・条件からして、実現可能なパターンはそう多くはなさそう。
 * 　少なくとも4,5あたりを手元で試そうとしてら、明らかに無理な感じがした。
 * ・そのあとしばらく3以外のうまくいくケースが考えられなかったんだけど、
 * 　Nを固定で考えずに各要素2つずつ、ここくらいしか置けるとこない、みたいなとこに置いていったら、
 * 　6でぴったり合う形を見つけた。ここからはもう早くて、同じ形で10ができるし15ができる。
 * ・該当の形を作る構築方法はちょっと考えたけどまあすぐできた。
 * ・当時これは自力で発想できなかったみたいだから解けて嬉しい。まあやったの2年前くらいだけど。
 */
