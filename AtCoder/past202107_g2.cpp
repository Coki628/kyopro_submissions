...
・なんとか時間内自力AC。危なかった。。
・N進数、3冪、平衡3進法
・すぐ解けなくて飛ばして、戻ってきて終了間際に通した。
　3進数にして、1は普通に使う、2のとこは使える場所まで戻って貰ってくるみたいにした。
　でも貰ってくる時、通った途中の桁を全部更新し直したりあってややこしい。
・合ってるっぽい状態になってもWAになるので何でかと思ったら、
　正負両方入ってる状態になってる箇所があった。
　時間なかったから無理くりそこは後から消す感じにして、何とかAC。。
・終了後、整えた。負数が入ってるかどうか管理してなかったから、
　そこで正数と重複してた。チェックして、負数入ってたら
　正数入れないで負数抜く感じにしたらちゃんとなった。
*/
