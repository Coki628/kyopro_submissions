/*
・自力ならず。。ここをまさか落とすとは。
・2重ループで全ペア見ると間に合わないやつ。
　約数列挙、素因数分解、素数列挙、色々考えたけど答えに辿り着けず。
　外ループで片方決めて、なんとか相方ペアの状態減らせないか、
　の方針から抜け出せなかった。
・正解は、答えを決め打って全探索、だった。
　それも考えたんだけど、決めた時にその答えになるペアを見つける操作が
　どうしても線形以上かかるなぁ、で終わったんだよね。
　実際にはペアを探す必要はなくて、区間AB内にある倍数の個数を調べる、
　だったんだよね。。
　その数以下の倍数を割り算で出して、LRで差分取るやつで。
・追加。なんならこうやって内側で篩みたいなループ愚直に回してもいい。
　これならまだ思いつけたかもしれないなぁ。。
*/
