/*
・自力ならず。。悔しい。
・グラフ、UnionFind、木でUF、ソートしてUF
・UFって一般グラフの想定解法になることが多い印象なんだけど、
　これは木グラフでUFを使う問題だった。木DP方針で検討を続けると詰む。。
・ラスト10分くらいで本質に気付いてUF作ったんだけど、1ケースWAが取れなくて終了。
　結局、sizeの戻り値がintだったからint*intでオーバーフローしてたのが原因だった。。
*/
