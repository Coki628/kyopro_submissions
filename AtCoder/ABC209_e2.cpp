/*
参考：https://qiita.com/drken/items/4e1bcf8413af16cb62da#4-%E5%BE%8C%E9%80%80%E8%A7%A3%E6%9E%90-%E3%82%B5%E3%82%A4%E3%82%AF%E3%83%AB%E3%81%AB%E3%82%88%E3%82%8B%E5%BC%95%E3%81%8D%E5%88%86%E3%81%91%E3%81%AE%E3%81%82%E3%82%8B%E3%82%B2%E3%83%BC%E3%83%A0
・自力ならず。
・グラフに帰着、ゲームDP、引き分けのあるゲーム、後退解析
・けんちょんさんの記事が全て。これをやればいい。
　具体的には、逆辺にしたグラフで確定した頂点から順にBFSみたいにしていく。
　これで決まらなかった頂点はサイクルを回り続けるので引き分け。
*/
...
void solve() {
    ...
    while (que.size()) {
        ...
        for (ll v : nodes[u]) {
            ...
            if (dp[u] == 0) {
                ...
                dp[v] = 1;
                que.push(v);
            } elif (dp[u] == 1 and edgecnt[v] == 0) {
                // (元のグラフで)vから行ける頂点が全て勝ち確定なので、vは負け確定
                dp[v] = 0;
                que.push(v);
            }
        }
    ...
    rep(i, N) {
        // 今回のゲームで負けるのは、この次に言おうとする人なので、勝敗は逆になる
        if (dp[i] == 0) print("Takahashi");
        elif (dp[i] == -1) print("Draw");
        else print("Aoki");
    }
}
