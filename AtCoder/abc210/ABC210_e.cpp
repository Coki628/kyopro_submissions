...
・なんとか自力AC！
・最小全域木、GCD
・基本的にはクラスカルで最小全域木を作っていく流れになる。
　ただし全ての辺を陽に張っていこうとすると辺が多すぎるので、
　ある値が来た時にどんな辺が張られていくかをまとめて計算することを考える。
　操作を見ていくとGCDみがある。今の連結成分数をcurとして、
　操作後の連結成分数はgcd(cur, a)だし、張られる辺の数もここから求まる。
　本番中はgcdが1になった時を場合分けしてたけど、いらなかった。
*/
