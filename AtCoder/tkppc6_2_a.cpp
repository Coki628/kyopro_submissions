...
・その他埋めAC数上げ
・きっちり自力AC！
・ようはその時点での最大か最小にジグザグに置きたい状況で、
　順列なのでこれは隣り合う数から順に置いていかないとその次が置けなくなって、
　つまり上下2通りのどっちかに置いていくんだけど、
　始めの数によって枝分かれの回数が変わって、
　これはちょうどグリッドの経路数みたいなnCrで表せるはずで、
　全通り合わせると2冪になるっていう有名な話がある。
*/
