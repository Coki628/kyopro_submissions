/**
 * ・E8さん精選100+50問埋め：行列累乗
 * ・きっちり自力AC！まあこれは印象的な問題だしね。。
 * ・ビット演算の行列累乗
 * ・遷移行列の埋め方は蟻本見返して思い出した。
 * ・最初答え合わなくては？ってなってたけど、単位元&用のやつに変えるの忘れてて1のままだった。。
 */
...
void solve() {
    ...
    MatPow<ll> mp;
    auto res = mp.solve(mat, init, M-K);
    print(res[0]);
}
