...
　　　https://atcoder.jp/contests/abc204/submissions/23246223
　　　https://ei1333.github.io/library/
・ライブラリ整備：BM
・なんか色々試したけど中々うまくいかなくて、結局うしさんとこから全部持ってきたらできた。
　分かってみると、FPSパートは全部ライブラリに組み込まれちゃってるし、
　ほんとに愚直で前の方の項だけ用意すればいい感じ。すごい。
・注意点としては、berlekamp_masseyやった後、末尾外してリバース、
　元の数列はこっちと長さを合わせる。でも末尾外してリバースは常にやりそうだけど、
　何でライブラリ側に組み込まないんだろ。まあきっと何か理由があるんだろう。
*/
