/*
参考：https://emtubasa.hateblo.jp/entry/2020/12/28/122819
・AGC青diff以下残埋め
・自力ならず。まあこれも発想ゲーが過ぎるよな。。
・考え方は結構色々あるみたいだけど、ツバサさんの解説が一番入ってきた。
　まあこれでもちゃんと意味分かるまで結構考えたけど。。
・題意より、x+yが等しくなるとDさんから見える本数が減ってしまうので、
　x+yが等しくならないように、x-yが等しいもの、xが等しいもの、yが等しいものを頑張って増やしていく。
・1つずつ話を進める。まずx-yについて、x=yな点を10個打ち込み、10*10の領域を作って、これを1つの大きな点とみなす。
　ここから先の操作は全てこの大きな点毎に動かしていくものとする。こうすることで、
　今後はBさんについては常にDさんの1/10しか点が見えないので無視していい。
・同様に次はxについて考える。先程の大きな点を、間隔を空けながら今度は横並びに10個並べる。
　すると領域は10*200の横長なものになる。これでBさんと同様の議論で今度はAさんのことが解決する。
・最後にyについて考える。先程の領域をまた一点とみなして、今度は縦に10個並べる。
　ただしそのままだとDさんからも被ってしまうのが出てくるので、上に余白を作って200*200を1つの領域とする。
　最終的に200*2000の領域に1000本のピンが収まるような形になる。(自分ノート図も参照)
*/
