...
"""
参考：https://atcoder.jp/contests/joi2008ho/submissions/2208740
・Suffix Array, Sparse Tableの動作確認
・なんかprdさんの提出でさくっとsa構築してたから真似させて頂いた。
・文字列スライスはしまくってるはずだけど、なんかこれ蟻本のよりめちゃ速くてpythonAC0.1秒。
・でも同じ実装他のやつ(ABC141E)で試したらWAしたし、ソートの基準とかちょっと違うのかも。
"""
...
ans = 0
for i in range(NM):
    # 隣り合う各接尾辞がS,Tどちらに属するか
    if (sa.sa[i] < N) ^ (sa.sa[i+1] < N):
        # 異なる方に属していたら、LCPの最大を確認
