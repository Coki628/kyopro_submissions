/*
参考：https://qiita.com/tomato1997/items/83ccdfe0ce1f5548a42a
　　　https://ei1333.github.io/luzhiled/snippets/structure/segment-tree.html
・ライブラリ整備：2Dセグ木
・非再帰版の実装を見つけたので、これをpythonからC++に起こしてみた。
　0を欠番にするかの宗派が違ったので、初期化処理の添字調整が大変だった。。
　あとついでに色々普通のセグ木で使ってた機能を移植しといた。
・かなり速くなって、0.59秒→0.24秒でAC。
*/
