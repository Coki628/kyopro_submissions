 ...
 * ・さくっと自力AC！
 * ・ちょっと考察してBFSする。一瞬、経路要る？とか思ったけど、最短経路長だけあればいいので不要。
 * 　昔解いたやつみたら経路復元頑張ってたので、当時より効率よく解けて嬉しいね。
 */
...
int main() {
    ...
    if (res[H][W] == INF) {
        ...
        // 黒く塗れるマス = 全体 - 最短経路長 - 元々黒マス
        ll ans = H*W - res[H][W] - blackcnt;
        print(ans);
    }
    return 0;
}
