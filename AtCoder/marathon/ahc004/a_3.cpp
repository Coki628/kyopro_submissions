...
・マラソン精進
・山登り
・一致文字列のカウントとスコア計算作って、山登りした。操作回数が400回くらい。
　変更は1文字だけ変えてチェック。ここで毎回全チェックになるのが無駄っぽいので、
　なんかうまく部分更新用の速いチェック処理を作れないか検討中。
　スコアはちょい上がって18億5500万点くらい。
　と思ったけどなんかバグってて乱択みたいになってただけっぽい。
　カウント初期化してなかった。やったら、操作回数6回とかしかできなくなった。。
*/
