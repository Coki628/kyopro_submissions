...
・自力AC！！嬉しい。
・BITにぶたん、実験
・まとめられる場所を考えて思ったこと。簡単のため、a~cを0~2とする。
　ある位置を-1して手前区間を+1した時、今の左から貪欲方針の場合、
　その手前は全部1111...ってなってるはず。これは規則的なニオイがする。
　この部分を0000...とするまでにどのくらいかかるかを実験すると、
　綺麗に2冪-1が出てくる。ここに最初の-1する操作を合わせるとちょうど2冪。
　区間加算を陽にやらずに、この2冪回の操作を答えにまとめて追加すればOK。
・冷静に後から見返すと、これBITとかいらんね。前から見てくだけでいいじゃん。。
*/
