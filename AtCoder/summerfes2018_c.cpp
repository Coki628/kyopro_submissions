/*
参考：https://drive.google.com/drive/folders/1MZLE7H3x4xOwf7HIXsffjMMfEaW_eq79
・その他埋めAC数上げ
・なんとか自力AC！解説は通してから見た。
・可換性、結合性、エスパー
・しばらく悩んで、手元でサンプルを違う順番で合わせてみると、なんと全部同じ。
　これは順番関係ないやつか、となり前から適当に繋ぐと無事AC。
・解説より、交換法則も結合法則も成り立つやつは順番何でもいいって。
　言われると確かにそうだよね。。
*/
