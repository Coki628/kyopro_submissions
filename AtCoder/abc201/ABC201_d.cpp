/*
・きっちり自力AC！ただし若干実装もたついたのはよくない。
・グリッド、ゲームDP、メモ化再帰
・一方を点数を正の方向に向かわせて、他方を負の方向に向かわせる。
*/
...
void solve() {
    ...
    auto memo = list2d(H, W, -INF);
    auto rec = [&](auto&& f, ll h, ll w) -> ll {
        if (h == H-1 and w == W-1) return 0;
