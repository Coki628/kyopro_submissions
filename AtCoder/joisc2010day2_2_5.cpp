 ...
 * ・蟻本演習4-7-3
 * ・文字列検索、Aho-Corasick法
 * ・アホコラも使い方分かってきたのでこっちでも解いてみた。
 * 　この問題の場合は、一致する単語のうち、一番長いものを確認してそこから全体を遷移させるようにしてる。
 * ・多分合ってると思うんだけど、1件MLE。。。75MBくらいなんだけど、64MB制限きついな。
 */
...
int main() {
    ...
    rep(i, 0, N) {
        ...
        ll j = 0;
        // この位置で終わる単語のうち最大の単語長を取って、そこから遷移させる
