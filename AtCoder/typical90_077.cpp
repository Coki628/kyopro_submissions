/*
・E8さん典型90問埋め
・自力AC？でもフロー使うような話は半分ネタバレしてたからあんまり…。
・最大流、二部マッチング、復元
・8方向に向かって、辺を張れるなら張ってフロー流す。
　復元しやすいように、頂点番号ペアと方向はマップしておく。
*/
...
void solve() {
    ...
    // 8方向
    const vector<pii> directions = {{T, 0}, {T, T}, {0, T}, {-T, T}, {-T, 0}, {-T, -T}, {0, -T}, {T, -T}};
    map<pll, ll> uvtod;
    rep(u, N) {
        auto [x, y] = XY[u];
        rep(d, 8) {
