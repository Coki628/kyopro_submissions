/*
参考：https://kanpurin.hatenablog.com/entry/2021/08/29/230502
・別解。こっちも考えたんだ。考えたんだけど詰めれなかった。
・グラフに帰着、有向グラフの閉路検出
・題意から明らかに閉路があるとダメなグラフって感じはした。したんだけど。。
　同じ色の玉の場所を辺でつなごうとしたりして破滅。そうじゃなかったね。。
・色を頂点、操作順を辺とすると、元のリストの順番に、色の頂点に辺を張ってく感じになる。
　確かに言われるとこれは正しい感じ。探してたやつ。。
・これなら別に頂点番号も辺な形にならないから、本当に普通に閉路チェックやるだけ。
　DFSしても、トポソしても、SCCしても何でもできると思う。
*/
