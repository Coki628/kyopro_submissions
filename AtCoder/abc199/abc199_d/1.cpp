/*
参考：https://twitter.com/fuppy_kyopro/status/1385952985268637697
・自力ならず。。
・再帰全探索、UnionFind、乱択
・案外方針は近かった。普通にやってダメで、連結成分に分けるのをすぐ
　気付いたのはよかったけど、探索が0からNに順番だとダメで、
　DFS順とかにしないと意地悪ケースで落ちてたみたい。。
・でも実はDFSにしなくてもよくて、ランダムにするだけでも通った…。
　(TLでふっぴーさんの方針を参考にした。)
*/
