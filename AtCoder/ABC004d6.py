...
・内側のダイクストラとリストを、ちょっと最適化したやつにしてみたけど、
　pythonTLE、pypyMLEは変わらず。。それぞれACケースは増えたけどね。。
"""
...
class MinCostFlow:
    ...
    def flow(self, s, t, f):
        ...
        while f:
            ...
            v = t
            while v != s:
                w, cap, cost, x = G[prv_v[v]][prv_e[v]]
                G[prv_v[v]][prv_e[v]] = (w, cap-d, cost, _)
                w, cap, cost, y = G[v][x]
                G[v][x] = (w, cap+d, cost, y)
                v = prv_v[v]
        return res
