/**
 * ・E8さん精選100+50問埋め：Grundy数
 * ・自力AC！いい感じ。
 * ・Grundy数、メモ化再帰
 * ・白と黒の石の数を状態に持ってGrundy数を求めていく。
 * 　各遷移はゲームにおける3つの操作を考えればOK。
 * 　白は増えるけど、それでも200*100の状態と100程度の遷移なので間に合う。
 * ・各場のゲームは独立なので、結果のGrundy数を全部xorすれば全体の勝者が分かる。
 */
