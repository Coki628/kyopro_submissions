...
・AOJコース埋め
・クエリ、累積和にぶたん
・10万N*500クエリの5000万だから、log乗るとちょっときつめかなーと思いつつも
　一応投げてみたらちゃんと通った。AC1.32秒(制約3秒)。
・尺取りで線形にすればもっと余裕持って通るんだろうね。
・てか後から気付いたけどこれ昔蟻本演習でやってるじゃん。
　Pythonで尺取りしてTLEしてたみたい。AOJはpypyないからね…。
*/
