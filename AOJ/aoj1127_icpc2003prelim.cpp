 ...
 * ・さくっと自力AC！
 * ・題材は3次元空間で変わってるけど、やることは最小全域木の構築。
 * 　3次元での2点間距離とか誤差めっちゃ怖かったけど、普通にやって何事もなくAC。
 */
...
void print() { cout << '\n'; }
void print(ld out) { cout << fixed << setprecision(3) << out << '\n'; }
...
using pld = tuple<ld, ld, ld, ld>;

// 3次元空間上の2点間距離
ld get_dist(pld p1, pld p2) {
